...
public interface BookingResource {
        ...
        ResponseEntity<BookingOrderResponseModel> createBooking(
                        @Parameter(name = "bookingRequestId", description = "booking request id") @Schema(description = "Reference", example = "bk_req_8732njsf87yh", required = true) @PathVariable("bookingRequestId") String bookingRequestId,
        ...
        ResponseEntity<BookingDataResponseModel> updateBooking(
                        @Parameter(name = "bookingId", description = "bookingId") @Schema(description = "Reference", example = "bk_8732njasdfasf87yh", required = true) @PathVariable("bookingId") String bookingId,
        ...
        ResponseEntity<BookingDataResponseModel> getBookingDataByBookingRequestId(
                        @Parameter(name = "bookingRequestId", description = "booking request id") @Schema(description = "Reference", example = "bk_req_8732njsf87yh", required = true) @RequestParam(value = "bookingRequestId", required = true) String bookingRequestId);
        ...
        ResponseEntity<BookingDataResponseModel> getBookingData(
                        @Parameter(name = "bookingId", description = "booking Id") @Schema(description = "Reference", example = "bk_8732njsf87yh", required = true) @PathVariable("bookingId") String bookingId);
